...
digitDatasetPath = fullfile('/home/das/sources/IKEA/Rumania2/letras');
...
size_images = size(img)

%%
% Each digit image is 53-by-26-by-1 pixels.
...
% from each label.
trainingNumFiles = 20;  % aprox 75% del tamaño de cada clase (directorio).
...
layers = [imageInputLayer([53 26 1])
...
%fullyConnectedLayer(9)=num. classes ->10
%%
